...
try {
    ...
    std::vector<char> v3(5); for (u_long i = 0; i < v3.size(); ++i) ; std::cout << "Success 13!\n";
    std::vector<char> v4(5); for (u_long i = 0; i <= v4.size(); ++i) ; std::cout << "Success 14!\n";
    std::string s5 = "Success 15!\n"; for (auto i: s5) std::cout << i;
    if (true) std::cout << "Success 16!\n"; else std::cout << "Fail!\n";
    int x1 = 2000; char c3 = x1; if (c3 == (char) 2000) std::cout << "Success 17!\n";
    std::string s6 = "Success 18!\n"; for (auto i: s6) std::cout << i;
    std::vector<int> v5; for (u_long i = 0; i <= v5.size(); ++i) ; std::cout << "Success 19!\n";
