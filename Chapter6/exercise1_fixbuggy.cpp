/*
 * This code counts for exercises 1, 2 and 3 as listed in the book.
 * 1. Fix the buggy code from calculator00.cpp
 * 2. Allow use of {} for brackets
 * 3. Implement factorial operator !
 */
